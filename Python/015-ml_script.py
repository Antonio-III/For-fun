...
SUPPORTED_MODELS= ["LinearRegression()", "KNeighborsClassifier()", "DecisionTreeClassifier()"]
...
if __name__ == "__main__":
    ...
    seed = input(f"Enter seed (Enter {NO_SEED_INPUT} to auto generate seed). Must be at least {MIN_SEED}:\n")
    ...
    for model in SUPPORTED_MODELS:
        ...
        output = model_predict(dataset = dataset,
                               dependent_var = dependent_var,str_data_present = str_data_present,str_columns = str_columns,
                               random_state = random_state,
                               test_size = test_size,
